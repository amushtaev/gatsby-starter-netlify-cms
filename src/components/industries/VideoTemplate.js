...
const VideoTemplate = (props) => {
  const { video } = props
  const itemImgSrc =
    'https://s3.eu-central-1.amazonaws.com/media.softcube.com/' +
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <div
          className={`template-video-item__overlay ${
            onMouseEnterHandler ? 'opacity_load__video' : 'opacity_null'
          }`}
        ></div>
      </div>
      <>
