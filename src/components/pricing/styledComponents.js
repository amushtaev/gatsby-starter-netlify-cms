...
export const DarkRectangle = styled.div`
  ...
  background: linear-gradient(
      270deg,
      rgba(18, 18, 47, 0.24) 0%,
      rgba(18, 18, 47, 0) 62.95%
    ),
    rgba(18, 18, 47, 0.82);
...
export const CommentContainer = styled.div`
  box-shadow: ${(props) =>
    props.noShadow ? 'none' : '10px 10px 15px rgba(8, 8, 22, 0.5)'};
  height: 214px;
  padding: 24px;
...
const Button = styled.button`
  ...
  height: 64px;
  background: ${(props) => (props.disabled ? '#fed300' : '#fed300')};
  border-radius: 60px;
  border: none;
  outline: none;
  padding: 0 40px;
...
export const CardHeader = styled.div`
  ...
  height: 196px;
  background: #46465d;
  box-shadow: -10px -10px 20px rgba(47, 47, 80, 0.5),
    10px 10px 20px rgba(8, 8, 22, 0.5);
