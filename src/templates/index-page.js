  ...
  return (
    <Layout>
      <PricingPageContainer>
        ...
        <SloganSmall>
          Paste your link and the Softcube AI will automatically create video
          ads that convert
        </SloganSmall>
        <VideoBaner />
  ...
  return (
    <IncludeContainerIndex>
      ...
      <div className="automatic-creat-img">
        <img
          src={AutomaticImgRectangle}
          alt="AUTOMATICALLY CREATE & OPTIMIZE VIDEO ADS"
        />
      </div>
    </IncludeContainerIndex>
  )
  ...
  return (
    <>
      <div className="marketing-videos" style={{ marginTop: '62px' }}>
        ...
        <div className="marketing-videos--content">
          <Link to={'/industries/#food-and-delivery'}>
      ...
      <div className="marketing-videos" style={{ marginTop: '62px' }}>
        <div className="marketing-videos--content">
          ...
          <div className="works-text--inner">
            <span className="marketing-videos--title">
              Crawl your listing page
            </span>
            <span className="marketing-videos--text">
              The Softcube AI scans your listing page and gets important
              information for creating your video ad
            </span>
          </div>
        </div>
        <div className="marketing-videos--content">
          ...
          <div className="works-text--inner">
            ...
            <span className="marketing-videos--text">
              The AI algorithm picks the best-suited scenes from Softcube's
              product video library of over 2 million clips
            </span>
          </div>
        </div>
        <div className="marketing-videos--content">
          ...
          <div className="works-text--inner">
            <span className="marketing-videos--title">
              Compile the video ad
            </span>
            <span className="marketing-videos--text">
              Softcube customizes a template with product- or industry-specific
              videos, text from the listing page, your logo, and your brand
              colors
            </span>
          </div>
        </div>
  ...
  return (
    <>
      <div className="marketing-videos" style={{ marginTop: '82px' }}>
        <div className="marketing-videos--content">
          <div
            className="maximize-text--inner"
            style={{
              display: 'grid',
              gridTemplateRows: '303px 56px 183px 74px',
            }}
          >
            ...
            <span className="marketing-videos--text">
              Launch an advertising campaign in Facebook Ads Manager or in Page
              ads (using the Promote button on your Instagram Page) and show
        ...
        <div className="marketing-videos--content">
          ...
          >
            ...
            <span className="marketing-videos--text">
              Run an advertising campaign in Facebook Ads Manager and show your
              ads on Facebook and the Audience Network
            </span>
            <BigButtonStyled
              text="Learn more"
              onClick={() => {
...
function WhatOurClientSay() {
  ...
  return (
    <>
      <IndexHeading>WHAT OUR CLIENT SAY</IndexHeading>
      <div
